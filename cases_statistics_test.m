...
formatSpec_data_title ='%-8s %-13s %-4s %-8s %-5s %-9s %-15s %-10s -17s\n';
formatSpec_data = '%-8d %-13s %-4d %-8d %-5d %-9d %-15d %-10.4f %-17.4f\n';
...
for n_robots = N_robots
    for prey = prey_algorithms
        ...
        moves_per_second_collect = zeros(n_seeds,1);
        avg_runtimes = 0;
        avg_moves_per_second = 0;
        ...
        for seed = 1:n_seeds         
            ...
            fprintf(fileID_data,formatSpec_data,n_robots,prey,seed,...
                ...
                runtimes(seed),moves_per_second_collect(seed));
        ...
        avg_moves_per_second = avg_moves_per_second / captures;
